...
function Driver.get_intent(profile)
  ...
  return {
    ...
    jump_wheelie_pressed = InputManager.consume_pressed("jump_wheelie"),
    jump_wave_pressed = InputManager.consume_pressed("jump_wave"),
    dash_pressed = InputManager.consume_pressed("dash"),
    fire_mud_hose = InputManager.is_down("fire_mud_hose"),
    spawn_enemy_pressed = InputManager.consume_pressed("spawn_enemy"),
